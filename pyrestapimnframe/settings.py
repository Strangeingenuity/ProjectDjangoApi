"""
Django settings for pyrestapimnframe project.
...
SECRET_KEY = '7z%#gckdfai@*(md!(p*-dg%)m7_72x2y=+$$8uem6mis7!0zj'
...
ROOT_URLCONF = 'pyrestapimnframe.urls'
...
WSGI_APPLICATION = 'pyrestapimnframe.wsgi.application'
